...
def build_review_graph() -> StateGraph:
    ...
    # Common path continues from here
    graph.add_edge("detect_changes", "prepare_context")
    graph.add_edge("prepare_context", "style_agent")
    graph.add_edge("style_agent", "bug_agent")
    graph.add_edge("bug_agent", "context_agent")
    graph.add_edge("context_agent", "summary_agent")
